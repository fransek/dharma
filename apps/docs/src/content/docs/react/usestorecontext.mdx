...
description: useStoreContext API reference.
---

A hook used to access a store context created with [`createStoreContext`](/react/createstorecontext).
It will throw an error if the context value is null.
